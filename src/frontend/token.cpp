...
bool is_keyword(TokenKind kind) {
    return kind >= TokenKind::KwLet && kind <= TokenKind::KwFinally;
}
...
std::string_view token_kind_name(TokenKind kind) {
    switch (kind) {
        ...
        case TokenKind::KwUndefined:return "KwUndefined";
        ...
        case TokenKind::EqEqEq:     return "EqEqEq";
        case TokenKind::BangEqEq:   return "BangEqEq";
